    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        self.transaction_prompt = ChatPromptTemplate.from_messages([
            (
                ...
                "7. CATEGORY: Categorize each transaction into one of these categories:(IMP NOTE: Use reasoning and contextual understanding to infer the most appropriate category based on the transaction description. "
            "Do not rely only on keywords. Focus on the purpose or intent behind the transaction.)\n"
                "   - Income\n"
                "   - Housing\n"
                "   - Transportation\n"
                "   - Food & Dining\n"
