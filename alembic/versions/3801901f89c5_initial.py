...
Revision ID: 3801901f89c5
Revises: 
Create Date: 2025-05-31 10:49:28.325616
...
def upgrade() -> None:
    ...
    op.drop_table('test_hello_supabase')
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('test_hello_supabase',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('message', sa.TEXT(), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='test_hello_supabase_pkey')
    )
